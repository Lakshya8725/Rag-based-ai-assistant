"""
Step 4 of the RAG pipeline: embed merged JSON chunks via Ollama.

Same as preprocess_json.py, but reads from `new_jsons/` (merged chunks)
and writes to `new_embeddings.joblib`.
"""
...
INPUT_DIR = "new_jsons"
OUTPUT_FILE = "new_embeddings.joblib"
